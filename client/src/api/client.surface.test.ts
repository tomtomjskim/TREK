...
describe('client > endpoint wiring', () => {
  ...
  it('FE-APISURF-010: adminApi maps user, addon and settings endpoints', async () => {
    await assertCalls([
      ...
      { n: 'getPlacesEnrich (legacy)', r: () => adminApi.getPlacesEnrich(), e: 'GET /api/admin/places-enrich' },
      { n: 'updatePlacesEnrich (legacy)', r: () => adminApi.updatePlacesEnrich(true), e: 'PUT /api/admin/places-enrich' },
      { n: 'getPlacesEnrichment (v4)', r: () => adminApi.getPlacesEnrichment(), e: 'GET /api/admin/places-enrichment' },
      { n: 'updatePlacesEnrichment (v4)', r: () => adminApi.updatePlacesEnrichment(true), e: 'PUT /api/admin/places-enrichment' },
