...
const admin: TranslationStrings = {
  ...
  'admin.placesEnrichment.title': '장소 상세 최신화 및 가져오기 보강',
  'admin.placesEnrichment.subtitle':
    '가져온 장소의 정보를 보강하고 저장된 장소 상세를 Google Places로 최신화하도록 허용합니다. 사용량이 예상보다 높으면 이 기능부터 비활성화하세요.',
  'admin.googleUsage.title': 'Google Places 사용량',
  'admin.googleUsage.scope':
    'TREK에서 발생시킨 요청만 표시합니다. 이 로컬 안전 원장은 Google Cloud 청구 총액이 아니므로 최종 비용은 Google Cloud Billing과 함께 확인하세요.',
  'admin.googleUsage.refresh': '사용량 새로고침',
  'admin.googleUsage.refreshShort': '새로고침',
  'admin.googleUsage.loading': 'Google Places 사용량 불러오는 중',
  'admin.googleUsage.loadError': 'Google Places 사용량을 불러올 수 없습니다.',
  'admin.googleUsage.retry': '다시 시도',
  'admin.googleUsage.period': '청구 기간',
  'admin.googleUsage.remaining': '{count}회 남음',
  'admin.googleUsage.exhausted': '한도 도달',
  'admin.googleUsage.officialCap': 'Google 무료 사용 참고치: {count}',
  'admin.googleUsage.officialUnlimited': 'Google 무료 사용 참고치: 무제한',
  'admin.googleUsage.failedCalls':
    'TREK은 Google 호출 전에 사용량을 예약하므로 공급자 호출 실패도 이 수치에 포함될 수 있습니다. Google의 집계 방식과 차이가 날 수 있으며, 이는 보수적인 운영 보호장치이지 청구 방지 보장은 아닙니다.',
  'admin.googleUsage.sku.autocomplete': '자동완성',
  'admin.googleUsage.sku.textSearchIdsOnly': '텍스트 검색 (ID만)',
  'admin.googleUsage.sku.textSearchPro': '텍스트 검색 Pro',
  'admin.googleUsage.sku.textSearchEnterprise': '텍스트 검색 Enterprise',
  'admin.googleUsage.sku.placeDetailsIdsOnly': '장소 상세 (ID만)',
  'admin.googleUsage.sku.placeDetailsEnterprise': '장소 상세 Enterprise',
  'admin.googleUsage.sku.placeDetailsAtmosphere': '장소 상세 + 분위기 정보',
  'admin.googleUsage.sku.placePhotos': '장소 사진',
