...
const settings: TranslationStrings = {
  ...
  'settings.mapLabelLanguage': '지도 표기 언어',
  'settings.mapLabelLanguageAuto': '앱 언어 따르기',
  'settings.mapLabelLanguageLocal': '현지어 / 고유 명칭',
  'settings.mapLabelLanguageKorean': '한국어',
  'settings.mapLabelLanguageEnglish': '영어',
  'settings.mapLabelLanguageRasterHint':
    '래스터 타일의 글자는 TREK에서 바꿀 수 없습니다. 이 설정은 MapLibre 또는 Mapbox GL 사용 시 적용됩니다.',
  'settings.mapLabelLanguageVectorHint':
    '선택한 벡터 스타일에 번역이 있으면 지정한 언어로 이름을 표시하고, 없으면 현지 명칭을 사용합니다.',
  ...
  'settings.calendarWeekStart': '주 시작 요일',
  'settings.calendarWeekStartHint': '날짜 선택기와 휴가 캘린더에 적용됩니다.',
