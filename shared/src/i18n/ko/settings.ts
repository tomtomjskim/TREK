...
const settings: TranslationStrings = {
  ...
  'settings.mapLabelLanguageRasterHint': '래스터 타일의 글자는 TREK에서 바꿀 수 없습니다. 이 설정은 MapLibre 또는 Mapbox GL 사용 시 적용됩니다.',
  'settings.mapLabelLanguageVectorHint': '선택한 벡터 스타일에 번역이 있으면 지정한 언어로 이름을 표시하고, 없으면 현지 명칭을 사용합니다.',
