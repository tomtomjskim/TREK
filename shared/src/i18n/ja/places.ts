...
const places: TranslationStrings = {
  ...
  'places.enrichmentAction': '情報を更新',
  'places.enrichmentTitle': '場所の詳細を更新',
  'places.enrichmentIntro': '未連携の保存場所をGoogleの場所と照合し、結果を確認して選択した項目だけを反映します。',
  'places.enrichmentBillingTitle': '課金防止ガードが有効です',
  'places.enrichmentBillingHint':
    '検索は対象ごとにText Search Proを1回、反映は選択ごとにPlace Details Enterpriseを1回使用します。TREKはGoogleが公開する月間無料枠の80%で呼び出しを停止します。',
  'places.enrichmentEligible': '座標のある未連携の場所 {count} 件を検索できます。',
  'places.enrichmentNoEligible': '検索が必要な未連携の場所はありません。',
  'places.enrichmentScanSingular': '1件を検索',
  'places.enrichmentScan': '{count}件を検索',
  'places.enrichmentScanning': '周辺のGoogleの場所を検索中…',
  'places.enrichmentResults': '{count}件を検索しました',
  'places.enrichmentSelect': '{name}を選択',
  'places.enrichmentCandidate': '{name}のGoogle候補',
  'places.enrichmentNoMatch': '近くに一致するGoogleの場所が見つかりませんでした。',
  'places.enrichmentSafe': '信頼度の高い候補',
  'places.enrichmentReview': '確認が必要',
  'places.enrichmentApply': '選択した{count}件を反映',
  'places.enrichmentApplying': '反映中…',
  'places.enrichmentQuotaReached': '月間Google安全上限に達しました。次の請求月までGoogle呼び出しを停止します。',
  'places.enrichmentFailed': '場所の詳細を検索できませんでした。',
  'places.enrichmentApplyFailed': '選択した場所の詳細を反映できませんでした。',
  'places.enrichmentScanErrorSingular': '1件の場所を検索できませんでした。保存済みデータは変更していません。',
  'places.enrichmentScanErrors': '{count}件の場所を検索できませんでした。保存済みデータは変更していません。',
  'places.enrichmentApplyErrorSingular': '選択した1件を更新できませんでした。完了済みの変更は保持されています。',
  'places.enrichmentApplyErrors': '選択した{count}件を更新できませんでした。完了済みの変更は保持されています。',
  'places.enrichmentUpdatedSingular': '1件を更新しました',
  'places.enrichmentUpdated': '{count}件を更新しました',
  'places.enrichmentDoneHint': '既存のメモ、カテゴリ、予定、入力済みの項目は保持されました。',
};
